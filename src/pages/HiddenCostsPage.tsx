          ...
          <div className="space-y-3">
            <details className="bg-white rounded-lg border border-gray-200 p-4 group">
              <summary className="font-medium cursor-pointer list-none flex justify-between items-center">
                ...
                <svg className="w-5 h-5 text-gray-400 group-open:rotate-180 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="6 9 12 15 18 9"/></svg>
              </summary>
              <p className="text-gray-600 mt-2 text-sm">Tak, jeśli przekroczysz limit wcześniejszej spłaty w okresie karencji (zwykle pierwsze 3-5 lat). Bank może naliczyć prowizję za nadpłatę w wysokości do 3% nadpłacanej kwoty. Po upływie okresu karencji — zgodnie z ustawą o kredycie hipotecznym — bank nie może pobierać prowizji za wcześniejszą spłatę.</p>
            </details>
            <details className="bg-white rounded-lg border border-gray-200 p-4 group">
              <summary className="font-medium cursor-pointer list-none flex justify-between items-center">
            ...
            <details className="bg-white rounded-lg border border-gray-200 p-4 group">
              ...
              <p className="text-gray-600 mt-2 text-sm">Ubezpieczenie niskiego wkładu własnego (zwane też ubezpieczeniem LTV) jest wymagane, gdy Twój wkład własny jest niższy niż 20% wartości nieruchomości (LTV powyżej 80%). Chroni bank na wypadek spadku wartości nieruchomości. Koszt to zwykle 1-3% różnicy między wkładem a 20%, płatne jednorazowo z góry.</p>
            </details>
            <details className="bg-white rounded-lg border border-gray-200 p-4 group">
              <summary className="font-medium cursor-pointer list-none flex justify-between items-center">
