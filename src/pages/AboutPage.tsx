  ...
  return (
    <TabContainer title="O projekcie" subtitle="Dlaczego stworzyliśmy ten kalkulator?">
      ...
      <section>
        ...
        <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Kim jesteśmy?</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Współpraca z instytucjami</h2>
        ...
        <ul className="text-muted-foreground space-y-2">
          ...
          <li>
            ...
            <a href="https://www.zbp.pl/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline ml-1">
              Więcej na zbp.pl
            </a>
          </li>
        </ul>

        <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Redaktor prowadzący</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Nasze źródła danych</h2>
