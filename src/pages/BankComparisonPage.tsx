  ...
  return (
    <>
      ...
      <div className="space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900">Jak znaleźć najlepszy kredyt hipoteczny?</h2>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mt-4">
            ...
            <ul className="space-y-2">
              <li>🔗 <a href="https://www.bankier.pl/smart/kredyty-hipoteczne" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline font-medium">Bankier.pl — ranking kredytów hipotecznych</a>
                <span className="text-gray-500"> — comiesięczny ranking redakcyjny</span></li>
              <li>🔗 <a href="https://totalmoney.pl/kredyty-hipoteczne" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline font-medium">TotalMoney.pl — porównywarka kredytów</a>
                <span className="text-gray-500"> — na żywo od partnerów</span></li>
            </ul>
          </div>
          <h3 className="text-xl font-semibold text-gray-900 mt-6">Na co zwracać uwagę?</h3>
        ...
        <section className="border-t border-gray-100 pt-6">
          <h2 className="text-2xl font-bold text-gray-900">Podstawa prawna i źródła danych</h2>
        ...
        <section className="border-t border-gray-100 pt-6">
          <h3 className="text-lg font-bold text-gray-700">Zobacz także:</h3>
          <ul className="space-y-1">
            <li><Link to="/poradniki/jak-obliczyc-rate/" className="text-blue-600 hover:underline">Jak obliczyć ratę kredytu? — Kompendium wiedzy</Link></li>
            <li><Link to="/poradniki/zdolnosc-kredytowa/" className="text-blue-600 hover:underline">Zdolność kredytowa — Kompendium wiedzy</Link></li>
          </ul>
        </section>
