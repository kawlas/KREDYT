  ...
  return (
    ...
    >
      ...
      <div className="text-center py-12">
        <div className="text-6xl mb-6 text-gray-300"><svg width="72" height="72" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="mx-auto"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg></div>
