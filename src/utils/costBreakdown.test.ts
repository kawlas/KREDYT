...
describe('costBreakdown', () => {
  it('calculates breakdown for standard mortgage (LTV 80%)', () => {
    const result = calculateCostBreakdown(400000, 500000, 250000, 2120, 25)
  ...
  it('triggers credit insurance when LTV > 80%', () => {
    const result = calculateCostBreakdown(450000, 500000, 280000, 2400, 25)
  ...
  it('calculates notary based on property value', () => {
    const cheapHome = calculateCostBreakdown(160000, 200000, 100000, 900, 25)
    const expensiveHome = calculateCostBreakdown(800000, 1000000, 500000, 4300, 25)
