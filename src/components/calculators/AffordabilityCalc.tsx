    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-6">
          <Card>
            <h2 className="text-xl font-semibold text-foreground mb-6 border-b pb-4">Dane finansowe</h2>
        ...
        <div className="space-y-6 md:sticky md:top-8">
          ...
          <Card title="Dostępny kredyt (szacunkowo)">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-foreground uppercase tracking-widest border-b pb-2">
                Parametry obliczeń
              </h3>
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Dochód korygowany:</span>
                  <span className="font-bold text-foreground">{formatCurrency(affordabilityResults.effectiveIncome)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Wolne środki na ratę:</span>
                  <span className="font-bold text-foreground">{formatCurrency(affordabilityResults.disposableIncome)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Max okres:</span>
                  <span className="font-bold text-foreground">{formatMonths(affordabilityResults.maxTermMonths)}</span>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card title="Maksymalna rata">
            <div className="bg-primary/10 rounded-xl p-6 border border-primary/30 mb-6">
              <p className="text-3xl font-bold text-foreground">
