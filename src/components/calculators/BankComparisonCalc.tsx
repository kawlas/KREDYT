      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input type="number" step="0.01" value={margin} onChange={e => setMargin(Number(e.target.value))}
                  className="w-full px-2 py-1.5 border rounded text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
                <p className="text-xs text-gray-400 mt-0.5">Wpisz marżę którą proponuje bank. Typowo 1.5–3.5%.</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-2">
            ...
            {lastUpdate && <p className="text-sm text-gray-400">Ostatnia aktualizacja WIBOR: {lastUpdate}</p>}
          </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          <Card>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 text-center">
                <p className="text-sm text-blue-600 font-medium">Miesięczna rata</p>
          ...
          {/* Educational info */}
          <Card>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Jak liczyć koszt kredytu?</h3>
